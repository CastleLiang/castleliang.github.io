...
I have published some papers in refereed journals and conferences, including DM venues (e.g., KDD\*7, WWW\*7, ICDE\*2, TKDE\*5, TMC\*1), AI venues (e.g., TPAMI\*1, AI Journal\*2, NeurIPS\*5, IJCAI\*4, AAAI\*5, ICLR\*4), and CV venues (e.g., ECCV\*1, MM\*3). Here are some representative papers:
